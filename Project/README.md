...
- **🎙️ Voice-to-Text & Translation**: Utilizes OpenAI's Whisper model to transcribe audio and translate regional languages (like Tamil) into English automatically.
